...
class peluqueria:
    ...
    #procedimientos
  def CalculoPeluqueria(clientest, t_min, t_max, llegada, peluqueros):
    num_peluqueros = peluqueros
    tiempo_corte_min = t_min
    tiempo_corte_max= t_max
    t_llegadas = llegada
    tot_clientes= clientest
    def  cortar(cliente):
      global dt
      R = random.random()
